...
Assume $M$ model parameters and $N$ observations (in our problem, $N=12$ arrival times).
Do not list numbers for the dimensions; instead use $M$ and $N$ (and 1).
\label{tab:funs}
}}
\begin{spacing}{4}
\hspace{-1.2cm}
...
\hline\hline 
\verb+tt+ & & {\tt x,y,t,v,xr,yr} & $g_i(\bem)$ & $M \times 1$ & $1 \times 1$ & \\ \hline
\verb+d+  & & & & & & \\ \hline
\verb+G+  & & & & & & \\ \hline
\verb+S+  & & & & & & \\ \hline
\end{tabular}
