...
\item Comment the \verb+break+ statement at the end, and then reproduce the spectrogram in \refFig{fig:BOOM} by following the 7 steps within the Matlab comments.
...
\caption[]
{{
Possibly triggered earthquakes during the 2012 Sumatra \magw{8.6} earthquake in Alaska.
\label{tab:triggered}
}}
\begin{spacing}{1.5}
