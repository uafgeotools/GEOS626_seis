...
\item Shear velocity, compressional velocity, phase velocity, group velocity.
...
%
\begin{enumerate}
\item (0.3) Turn in a plot showing the two eigenfunctions, and list your results in the format of the table below. \\
...
%
\begin{itemize}
\item Sketch (by hand or in Matlab) vertical bars corresponding to $f_{{\rm c}n}$.
\item Label the branches $n=0$, $n=1$, etc.
\end{itemize}

\item (0.2) Include an additional plot of phase speed versus period, and sketch (by hand or in Matlab) vertical bars corresponding to $f_{{\rm c}n}$ ($T_{{\rm c}n}$).
\end{enumerate}
