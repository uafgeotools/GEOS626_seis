...
%
\begin{enumerate}
\item (0.4) Set \verb+bload = false+ in \verb+sumatra_modes.m+, then modify \verb+ipick+ (or use \verb+wkeep.m+) and plot the stations you selected in \verb+lab_sumatra.pdf+. To save paper, use something like a $5 \times 4$ subplot.
