...
\item Figure~5 (\refFig{fig5}) shows the instrument response $I_d(\omega)$ to displacement, velocity $I_v(\omega)$, and acceleration $I_a(\omega)$. We will see in the homework that 
%
\begin{eqnarray*}
